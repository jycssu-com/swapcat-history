...
import { TokenTransaction } from 'src/api/Swapcat/GetTokenTransactions'
  ...
  setup (props) {
    ...
    async function fetch () {
      ...
      try {
        ...
        transactions.value = await SwapcatRepository.getTokenTransactions({ address: tokenAddress.value })
      } finally {
        loading.value = false
      }
    }
